  ...
  eventFunctions: {
    ...
    setFlexOrder: () => {
      ...
      if (
        ...
        //Firefox's sidebar position: left, Floorp's sidebar position: right | Vertical tab bar position: right
        fxSidebar.style.order = "0";
        fxSidebarSplitter.style.order = "1";
        browserBox.style.order = "2";
        verticaltabbarSplitter.style.order = "3";
        ...
        //Firefox's sidebar position: left, Floorp's sidebar position: left | Vertical tab bar position: right
        floorpSidebarSelectBox.style.order = "0";
        floorpSidebar.style.order = "1";
        floorpSidebarSplitter.style.order = "2";
        fxSidebar.style.order = "3";
        ...
        // Firefox's sidebar position: right, Floorp's sidebar position: right | Vertical tab bar position: right
        browserBox.style.order = "0";
        verticaltabbarSplitter.style.order = "1";
       ...
       floorpSidebarPositionPref === false
        ...
        //Firefox's sidebar position: right, Floorp's sidebar position: left | Vertical tab bar position: right
        floorpSidebarSelectBox.style.order = "0";
        floorpSidebar.style.order = "1";
        floorpSidebarSplitter.style.order = "2";
        browserBox.style.order = "3";
