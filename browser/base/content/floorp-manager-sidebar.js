...
import { addContextBox } from "./floorp-context-menu.js";
...
const bmsController = {
  eventFunctions: {
    ...
    contextMenu: {
      clickedWebpanel: "",
      show: event => {
        const clickedWebpanel = event.explicitOriginalTarget.id;
      ...
      showWithNumber: num => {
        const targetWebpanel =
          document.getElementsByClassName("sicon-list")[num];
  ...
  bmsWindowFunctions: {
    loadBMSURI: () => {
      ...
      window.gBrowser.loadURI(Services.io.newURI(embedded), {
        triggeringPrincipal:
